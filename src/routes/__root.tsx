...
const APP_NAME = "Qalam — کارگاه نگارش";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "کارگاه نگارش فارسی ایرانی: فکر به فارسی، رجیستر کامل از لندینگ تا پایان نامه، و حافظه قطعی Ada. بدون تقلید صدا و بدون حقه آشکارساز.",
      },

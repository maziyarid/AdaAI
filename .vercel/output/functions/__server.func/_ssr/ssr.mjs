...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BQqnWosE.mjs");
...
var manifest = {
	"757f7404502eeea822ff82d4285fe5a444e219a785f4dbedb372674a0bd43123": {
		functionName: "adaAuthorize_createServerFn_handler",
		importer: () => import("./server-DbWQZX6b.mjs")
	},
	"83b2377a2aa25180609c41a04b4203afc5b683e0fe22459c200d6b3181941e97": {
		functionName: "adaValidateReceipt_createServerFn_handler",
		importer: () => import("./server-DbWQZX6b.mjs")
	},
	"bd181e364d476b0f4d1795e829dc2e3b5c4beb7d503538562c3b037e66dec2d6": {
		functionName: "adaListMemory_createServerFn_handler",
		importer: () => import("./server-DbWQZX6b.mjs")
	},
	"e2783f68d3a24b8b11a24743b9a49d642c877b4997f44988a816b0bedcd90b66": {
		functionName: "adaBootstrap_createServerFn_handler",
		importer: () => import("./server-DbWQZX6b.mjs")
	},
	"f2f2bad8ddec0d3d59607398bf0c38878b16e6c9cb2aef0234e36cc1d77bdd54": {
		functionName: "adaQuarantine_createServerFn_handler",
		importer: () => import("./server-DbWQZX6b.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-IX03nS2D.mjs").then((n) => n.t),

...
import { i as cn, n as Route$21, r as Button } from "./router-IX03nS2D.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/desk-BiHZK64h.js
...
function scan(text, register) {
	...
	if (sents.length >= 5) {
		...
		if (avg > 40 && variance < 180) findings.push({
			id: "uniform-length",
			severity: "medium",
	...
	if (register === "ACADEMIC_READABLE" && /می ?دون|یه |چیکار|رو /.test(text)) findings.push({
	...
	if (register === "ACADEMIC_READABLE" && /ما .{0,32}(جمع آوری|پخش|استفاده) کردیم/.test(text)) findings.push({
	...
	if (register === "SERVICE_PAGE_NATURAL" && /پژوهش حاضر|مقاله حاضر|نگارنده/.test(text)) findings.push({
	...
	if (register === "LANDING_PRODUCT" && /پژوهش حاضر|مقاله حاضر|چکیده|نگارنده/.test(text)) findings.push({
	...
	if (/جهت .{0,20}پیام بدهید/.test(text)) findings.push({
	...
	if ((register === "ACADEMIC_READABLE" || register === "RESEARCH_GUIDE") && /چیه|چطوری|مون /.test(text)) findings.push({
		id: "telegram-in-body",
		severity: "high",
...
SAMPLE_DRAFTS.RESEARCH_GUIDE;
function isSampleDraft(text) {
	return Object.values(SAMPLE_DRAFTS).includes(text);
}
function scoreLabel(findings) {
	if (findings.some((f) => f.severity === "block")) return {
		label: "نیاز به بازنویسی از معنا",
		tone: "mark"
	};
	if (findings.some((f) => f.severity === "high")) return {
		label: "قابل ویرایش؛ رجیستر یا فعل مشکل دارد",
		tone: "warn"
	};
	if (findings.length) return {
		label: "قابل خواندن؛ چند لولا را کوتاه کنید",
		tone: "warn"
	};
	return {
		label: "نشانه قالبی آشکاری دیده نشد",
		tone: "ok"
	};
}
var SEV = {
...
function Desk() {
	const search = Route$21.useSearch();
	const initial = isRegister(search.register) ? search.register : "RESEARCH_GUIDE";
	const [register, setRegister] = (0, import_react.useState)(initial);
	const [text, setText] = (0, import_react.useState)(SAMPLE_DRAFTS[initial]);
	const [ran, setRan] = (0, import_react.useState)(true);
	const findings = (0, import_react.useMemo)(() => ran ? scan(text, register) : [], [
		ran,
		text,
		register
	]);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "max-w-2xl leading-7 text-ink-muted",
						children: "متن را در رجیستر مقصد بسنجید. ابزار سبک را تعمیر می کند، نه ادعا را. حقه آشکارساز پیشنهاد نمی شود."
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: REGISTERS.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: cn("h-11 shrink-0 rounded-full px-4 text-sm transition-colors duration-150", register === r.id ? "bg-slate text-slate-fg" : "bg-paper-elevated text-ink-muted shadow-[var(--shadow-border)]"),
						children: r.name
					}, r.id))
				})]
			}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Textarea, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "secondary",
								onClick: () => setText(SAMPLE_DRAFTS[register]),
								children: "نمونه ضعیف"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "ghost",
					...
					className: "flex flex-col gap-4 rounded-[24px] bg-paper-elevated p-5 shadow-[var(--shadow-border)]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: "نشانه قالبی آشکاری دیده نشد. هنوز باید پرسید: این بند چه چیز تازه ای اضافه می کند؟"
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "flex flex-col gap-3",
						children: findings.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FindingCard, { finding: f }, f.id + f.evidence))
					})]
				})]
			})
		]
...
function FindingCard({ finding }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
		className: "rounded-[16px] bg-paper p-4",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mt-2 font-mono text-xs text-mark",
				dir: "rtl",
				children: [
					"«",
					finding.evidence,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: finding.diagnosis
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-sm leading-6",
				children: finding.repair
			})
		]
	});
}
